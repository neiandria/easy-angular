...
export class DataService {
  ...
  private usuarioLogadoSubject = new BehaviorSubject<UsuarioLogado | null>(this.getUsuarioLogadoFromStorage());
  ...
  private loadInitialData() {
    ...
    const pacientes: Paciente[] = [
      { id_paciente: 1, nome: 'João Silva', data_nascimento: new Date('1985-06-15'), CPF: '123.456.789-00', sexo: 'Masculino', email: 'joao.silva@example.com', senha: 'senha123', telefone: '(11) 91234-5678' },
      { id_paciente: 2, nome: 'Maria Oliveira', data_nascimento: new Date('1992-11-30'), CPF: '987.654.321-00', sexo: 'Feminino', email: 'maria.oliveira@example.com', senha: 'senha456', telefone: '(21) 99876-5432' },
      { id_paciente: 3, nome: 'Mario Netto', data_nascimento: new Date('1992-11-30'), CPF: '987.654.321-00', sexo: 'Masculino', email: 'mario@example.com', senha: '123456', telefone: '(21) 99876-5432' },
    ];

    // Predefined Medicos
    const medicos: Medico[] = [
      { id_medico: 1, nome: 'Dr. Carlos Pereira', email: 'doctor@example.com', senha: '123456', telefone: '(11) 93456-7890', especialidade: 'Clínica Geral', CRM: 'SP12345', CPF: '111.222.333-44' },
      { id_medico: 2, nome: 'Dra. Ana Costa', email: 'ana.costa@clinica.com', senha: '123456', telefone: '(21) 94567-1234', especialidade: 'Pediatria', CRM: 'RJ67890', CPF: '555.666.777-88' },
    ];

    // Predefined Usuarios
    const usuarios: Usuario[] = [
      { id_usuario: 1, nome: 'Admin', email: 'admin@clinica.com', senha: 'admin123' },
    ];

    // Predefined Consultas
    const consultas: Consulta[] = [
      { id_consulta: 1, id_paciente: 1, id_medico: 1, data_consulta: new Date('2025-06-01T10:30:00'), status: 'agendada' },
      { id_consulta: 2, id_paciente: 2, id_medico: 2, data_consulta: new Date('2025-06-02T14:00:00'), status: 'agendada' },
      { id_consulta: 3, id_paciente: 3, id_medico: 2, data_consulta: new Date('2025-06-02T15:00:00'), status: 'agendada' },
      { id_consulta: 4, id_paciente: 3, id_medico: 2, data_consulta: new Date('2025-06-03T09:00:00'), status: 'agendada' },
      { id_consulta: 5, id_paciente: 2, id_medico: 2, data_consulta: new Date('2025-06-03T11:00:00'), status: 'agendada' },
    ];
